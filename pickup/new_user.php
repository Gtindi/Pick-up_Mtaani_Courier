...
if (isset($_POST['submit'])){
	...
	$sql="insert into `users` (firstname, middlename, lastname, mobile, address, email, password)
...
<form method="POST">
  ...
  <div class="mb-3">
    ...
    <input type="middlename" class="form-control" name="middlename"  placeholder="Middle Name">
  </div>
